...
class User(Model):
    ...
    def __init__(self, username: str=None, email: str=None, password: str=None, first_name: str=None, last_name: str=None, phone: str=None, sms: str=None, mail: str=None):  # noqa: E501
